---
title: 'ISO 42001 readiness: what organisations actually need to do'
...
This is the same discipline behind [ISO 42001 and AI-governance readiness](/internal-audit) in our assurance work.
...
We run ISO 42001 readiness reviews and AI-governance assessments, and we can build the management system with you through [Advisory](/advisory), then track the work in Assurance OS. If data protection is part of the picture, read our guide to [the Kenya Data Protection Act](/insights/kenya-data-protection-act).
...
Read [ISO’s official overview of ISO/IEC 42001](https://www.iso.org/standard/42001) for the standard’s scope and current edition. Readiness support is separate from independent certification.
