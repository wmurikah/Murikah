...
- **affiliates**: affiliate_code, organization_id, affiliate_name, country, region, is_active, created_at, updated_at, deleted_at, is_group
...
- **auditee_delegations**: delegation_id, organization_id, work_paper_id, round_number, delegated_by, delegated_by_name, delegated_to, delegated_to_name, instructions, status, delegated_at, returned_at, return_note, closed_at
...
- **work_paper_requirements**: requirement_id, work_paper_id, organization_id, description, requirement_type, status, notes, due_date, requested_date, received_date, created_at, updated_at, deleted_at, last_reviewed_date, closed_at, closed_by, linked_work_paper_id, linked_at, linked_by
