...
| `docs/images/murikah_6.png` | Standalone **M monogram** (light background)                                                         | `public/brand/murikah-monogram-light.png`. Compact mark, brand moments, fallback where the full lockup is too wide.                                                                                                                   |
