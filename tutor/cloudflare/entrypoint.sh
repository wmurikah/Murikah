...
export MURIKAH_FAST_CHAT_QWEN_MODEL="${MURIKAH_FAST_CHAT_QWEN_MODEL:-qwen3.8-flash}"
export MURIKAH_DASHSCOPE_OPENAI_BASE_URL="${MURIKAH_DASHSCOPE_OPENAI_BASE_URL:-https://dashscope-intl.aliyuncs.com/compatible-mode/v1}"
