...
CREATE TABLE IF NOT EXISTS competency_evidence (
  ...
  demonstrated_level TEXT NOT NULL CHECK (demonstrated_level IN ('developing','applied_with_support','independent')),
